...
public class class119 implements MouseWheel {
		...
		if (var0 != ScriptOpcodes.DB_FIND_WITH_COUNT && var0 != ScriptOpcodes.DB_FIND) {
			if (var0 != ScriptOpcodes.DB_FINDNEXT) {
				...
				if (var0 == ScriptOpcodes.DB_GETFIELD) {
					...
					DbTableType var27 = class229.getDbTableType(var20);
					...
					DbTableType var9 = class229.getDbTableType(var20);
	...
	static final void method2909() {
		...
		int var1 = UrlRequester.field1355 * 128 + 64;
		...
		var1 = MusicPatchNode.field3301 * 128 + 64;
