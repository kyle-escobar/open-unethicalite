							...
							label359: {
								...
								if (Login.method2084(class97.getWidgetFlags(var0))) {
									for (int var11 = 4; var11 >= 3; --var11) {
										if (var10 != var11) {
											FriendLoginUpdate.addWidgetItemMenuItem(var0, var8, var15, var11, false);
										}
									}
								}
								...
								if (var21) {
									for (var13 = 2; var13 >= 0; --var13) {
										if (var10 != var13) {
											FriendLoginUpdate.addWidgetItemMenuItem(var0, var8, var15, var13, false);
										}
									}

									if (var10 >= 0) {
										FriendLoginUpdate.addWidgetItemMenuItem(var0, var8, var15, var10, true);
									}
								}
