	...
	static void drawTitle(Font var0, Font var1, Font var2) {
		...
		if (Login.worldSelectOpen) {
			...
			if (Client.gameState >= 10) {
				...
				VertexNormal.loginScreenRunesAnimation.draw(Login.xPadding - 22, Client.cycle);
				VertexNormal.loginScreenRunesAnimation.draw(Login.xPadding + 22 + 765 - 128, Client.cycle);
