...
public final class Client extends GameEngine implements Usernamed, OAuthApi {
	...
	void method1586(String var1) throws IOException {
		...
		RefreshAccessTokenRequester var6 = this.field719;
		if (var6 != null) {
	...
	void method1193(String var1) throws MalformedURLException, IOException {
		...
		OtlTokenRequester var5 = this.field533;
		if (var5 != null) {
		...
		try {
			...
			if (loginState == 20) {
				if (this.field515 != null) {
					...
					try {
						OtlTokenResponse var33 = (OtlTokenResponse)this.field515.get();
						if (!var33.isSuccess()) {
							class12.getLoginError(65);
							this.field515 = null;
							return;
			...
			if (loginState == 1) {
				...
				if (Clock.socketTask.status == 1) {
					Socket var34 = (Socket)Clock.socketTask.result;
			...
			if (loginState == 2) {
				...
				var36 = PcmPlayer.method795();
				var36.clientPacket = null;
				var36.clientPacketLength = 0;
				var36.packetBuffer = new PacketBuffer(5000);
				var36.packetBuffer.writeByte(LoginPacket.field3182.id);
			...
			if (loginState == 5) {
				...
				packetWriter.clearBuffer();
				PacketBuffer var37 = new PacketBuffer(500);
				int[] var38 = new int[]{class29.secureRandom.nextInt(), class29.secureRandom.nextInt(), class29.secureRandom.nextInt(), class29.secureRandom.nextInt()};
				var37.offset = 0;
				var37.writeByte(1);
				var37.writeInt(var38[0]);
				var37.writeInt(var38[1]);
				var37.writeInt(var38[2]);
				var37.writeInt(var38[3]);
				var37.writeLong(class6.field16);
				int var9;
				if (gameState == 40) {
					var37.writeInt(class29.field176[0]);
					var37.writeInt(class29.field176[1]);
					var37.writeInt(class29.field176[2]);
					var37.writeInt(class29.field176[3]);
				} else {
					if (gameState == 50) {
						var37.writeByte(class125.field1540.rsOrdinal());
						var37.writeInt(MusicPatchNode2.field3223);
					} else {
						var37.writeByte(field528.rsOrdinal());
						switch(field528.field1544) {
						case 0:
						case 3:
							var37.writeMedium(class347.field4201);
							++var37.offset;
							break;
						case 1:
							...
							var37.writeInt((Integer)var6.get(var10));
						case 2:
						default:
							break;
						case 4:
					...
					if (field639.method8184()) {
						var37.writeByte(class448.field4785.rsOrdinal());
						var37.writeStringCp1252NullTerminated(this.field530);
					} else {
						var37.writeByte(class448.field4784.rsOrdinal());
						var37.writeStringCp1252NullTerminated(Login.Login_password);
					}
				}

				var37.encryptRsa(class67.field884, class67.field885);
				class29.field176 = var38;
				PacketBufferNode var44 = PcmPlayer.method795();
				var44.clientPacket = null;
				var44.clientPacketLength = 0;
				var44.packetBuffer = new PacketBuffer(5000);
				var44.packetBuffer.offset = 0;
				if (gameState == 40) {
					var44.packetBuffer.writeByte(LoginPacket.field3179.id);
				} else {
					var44.packetBuffer.writeByte(LoginPacket.field3187.id);
				}

				var44.packetBuffer.writeShort(0);
				int var7 = var44.packetBuffer.offset;
				var44.packetBuffer.writeInt(208);
				var44.packetBuffer.writeInt(1);
				var44.packetBuffer.writeByte(clientType);
				var44.packetBuffer.writeByte(field571);
				byte var16 = 0;
				var44.packetBuffer.writeByte(var16);
				var44.packetBuffer.writeBytes(var37.array, 0, var37.offset);
				var9 = var44.packetBuffer.offset;
				var44.packetBuffer.writeStringCp1252NullTerminated(Login.Login_username);
				var44.packetBuffer.writeByte((isResizable ? 1 : 0) << 1 | (isLowDetail ? 1 : 0));
				var44.packetBuffer.writeShort(class123.canvasWidth);
				var44.packetBuffer.writeShort(class166.canvasHeight);
				PacketBuffer var17 = var44.packetBuffer;
				int var13;
				...
				var44.packetBuffer.writeStringCp1252NullTerminated(AttackOption.field1279);
				var44.packetBuffer.writeInt(UserComparator10.field1393);
				Buffer var19 = new Buffer(class9.platformInfo.size());
				class9.platformInfo.write(var19);
				var44.packetBuffer.writeBytes(var19.array, 0, var19.array.length);
				var44.packetBuffer.writeByte(clientType);
				var44.packetBuffer.writeInt(0);
				var44.packetBuffer.method7916(HealthBar.archive17.hash);
				var44.packetBuffer.method7972(UserComparator10.archive4.hash);
				var44.packetBuffer.method7971(UserList.archive13.hash);
				var44.packetBuffer.writeInt(class283.field3325.hash);
				var44.packetBuffer.method7971(0);
				var44.packetBuffer.method7971(UserComparator10.archive19.hash);
				var44.packetBuffer.writeInt(DevicePcmPlayerProvider.archive5.hash);
				var44.packetBuffer.writeInt(class163.archive10.hash);
				var44.packetBuffer.method7971(class119.archive2.hash);
				var44.packetBuffer.method7972(ChatChannel.archive8.hash);
				var44.packetBuffer.method7916(class301.archive7.hash);
				var44.packetBuffer.method7916(Huffman.archive20.hash);
				var44.packetBuffer.writeInt(HorizontalAlignment.field1926.hash);
				var44.packetBuffer.writeInt(class83.field1081.hash);
				var44.packetBuffer.method7972(class14.archive6.hash);
				var44.packetBuffer.writeInt(class14.archive14.hash);
				var44.packetBuffer.method7971(class434.archive9.hash);
				var44.packetBuffer.writeInt(FaceNormal.archive11.hash);
				var44.packetBuffer.method7971(class19.archive15.hash);
				var44.packetBuffer.method7916(class102.archive12.hash);
				var44.packetBuffer.method7972(class67.archive18.hash);
				var44.packetBuffer.xteaEncrypt(var38, var9, var44.packetBuffer.offset);
				var44.packetBuffer.writeLengthShort(var44.packetBuffer.offset - var7);
				packetWriter.addNode(var44);
				packetWriter.flush();
				packetWriter.isaacCipher = new IsaacCipher(var38);
				int[] var46 = new int[4];
			...
			if (loginState == 7 && ((AbstractSocket)var1).available() >= 2) {
				...
				var2.offset = 0;
				class455.field4809 = var2.readUnsignedShort();
				class142.method3196(8);
			}

			if (loginState == 8 && ((AbstractSocket)var1).available() >= class455.field4809) {
				var2.offset = 0;
				((AbstractSocket)var1).read(var2.array, var2.offset, class455.field4809);
				class6 var39 = class117.method2863()[var2.readUnsignedByte()];

				try {
					class3 var40 = method1723(var39);
					this.field721 = new class7(var2, var40);
			...
			if (loginState == 9 && this.field721.method51()) {
				...
				var36.clientPacketLength = 0;
				var36.packetBuffer = new PacketBuffer(5000);
				var36.packetBuffer.writeByte(LoginPacket.field3183.id);
				var36.packetBuffer.writeShort(this.field542.offset);
				var36.packetBuffer.method8116(this.field542);
				packetWriter.addNode(var36);
				packetWriter.flush();
				this.field542 = null;
				class142.method3196(6);
			...
			if (loginState == 13) {
				...
				if (loginState == 15 && ((AbstractSocket)var1).available() >= class9.field31) {
					boolean var47 = ((AbstractSocket)var1).readUnsignedByte() == 1;
					...
					if (var47) {
						...
						if (Player.clientPreferences.parameters.size() >= 10 && !Player.clientPreferences.parameters.containsKey(var21)) {
							Iterator var45 = Player.clientPreferences.parameters.entrySet().iterator();
							var45.next();
							var45.remove();
						}
				...
				if (loginState == 16) {
					...
					if (loginState == 18 && ((AbstractSocket)var1).available() >= class97.field1320) {
						...
						SecureRandomCallable.setLoginResponseString(var41, var43, var42);
		...
		if (hadNetworkError) {
			...
			if (gameState == 30) {
				...
				if (field543 && field630 <= 0) {
					...
					var14.packetBuffer.method8075(camAngleY);
					packetWriter.addNode(var14);
				}
																...
																if (MouseHandler.MouseHandler_currentButton == 0) {
																	if (field763) {
																		if (User.dragInventoryWidget == SceneTilePaint.hoveredItemContainer && dragItemSlotSource != dragItemSlotDestination) {
																			...
																			var26.packetBuffer.method8075(dragItemSlotSource);
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field3132 == var1.serverPacket) {
					...
					PlayerType var80 = (PlayerType)Varps.findEnumerated(DbTableType.PlayerType_values(), var3.readUnsignedByte());
					var30 = var27 + (var25 << 32);
					boolean var69 = false;

					for (var15 = 0; var15 < 100; ++var15) {
						if (var30 == field785[var15]) {
							var69 = true;
							break;
						}
					}
				...
				if (ServerPacket.field3131 == var1.serverPacket) {
					...
					PlayerType var84 = (PlayerType)Varps.findEnumerated(DbTableType.PlayerType_values(), var3.readUnsignedByte());
				...
				if (ServerPacket.field3116 == var1.serverPacket) {
					...
					MusicPatchNode.field3301 = var3.readUnsignedByte() * 16384;
					...
					if (class93.field1270 >= 100) {
						...
						var5 = MusicPatchNode.field3301 * 128 + 64;
				...
				if (ServerPacket.field3164 == var1.serverPacket) {
					...
					PlayerType var43 = (PlayerType)Varps.findEnumerated(DbTableType.PlayerType_values(), var3.readUnsignedByte());
					long var44 = (var23 << 32) + var25;
					boolean var65 = false;

					for (var13 = 0; var13 < 100; ++var13) {
						if (field785[var13] == var44) {
							var65 = true;
							break;
						}
					}
				...
				if (ServerPacket.field3078 == var1.serverPacket) {
					...
					UrlRequester.field1355 = var3.readUnsignedByte() * 16384;
					...
					if (UserComparator6.field1398 >= 100) {
						...
						ApproximateRouteStrategy.cameraZ = UrlRequester.field1355 * 128 + 64;
			...
			if (MouseHandler.MouseHandler_currentButton == 0) {
				if (isDraggingWidget) {
					...
					if (draggedOnWidget != null && HitSplatDefinition.method3782(clickedWidget) != null) {
						...
						var9.packetBuffer.method8075(clickedWidget.childIndex);
						var9.packetBuffer.method7961(draggedOnWidget.itemId);
						var9.packetBuffer.method8075(clickedWidget.itemId);
