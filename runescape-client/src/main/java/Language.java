...
public class Language implements MouseWheel {
	...
	static {
		...
		Language_DE = new Language("DE", "de", "German", ModeWhere.field4158, 1, "DE");
		...
		Language[] var0 = new Language[]{Language_PT, Language_NL, Language_ES, Language_ES_MX, Language_EN, Language_FR, Language_DE};
